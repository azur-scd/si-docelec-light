export var binaryState = [{ "cle": 0, "valeur": "non" }, { "cle": 1, "valeur": "oui" }]
export var poleState = [{ "cle": "SCD", "valeur": "SCD" }, { "cle": "SHS", "valeur": "SHS" }, { "cle": "STM", "valeur": "STM" }]
export var marcheState = [
    { "cle": "", "valeur": "" },
    { "cle": "GC", "valeur": "GC" },
...
export var steps = [{ "cle": "prev", "valeur": "Prévisions" },
{ "cle": "exec", "valeur": "Exécution" }]
export var metrics = [{ "cle": "montant_ttc", "valeur": "Montants TTC après récup" },
{ "cle": "montant_ttc_avant_recup", "valeur": "Montants TTC avant récup" }]
export var months = [{ "cle": "janvier", "valeur": "Janvier", "start": "-01-01", "end": "-01-31","code":"01" },
...
export var sushiReportUrlSegment = [{"cle":"tr_j3","valeur":"Revues - Téléchargements (tr_j3)","mapReportId":1},
...
export var esgbuDisplayReport = [{"cle":"1,2,6","valeur":"Téléchargements"},
{"cle":"8","valeur":"Téléchargements uniques"},
{"cle":"4","valeur":"Recherches"},
{"cle":"5,7","valeur":"Sessions"}]
export var userGroups = [{ "cle": "admin", "valeur": "Admin" },
{ "cle": "docelec", "valeur": "Docelec" },
{ "cle": "horaires", "valeur": "Horaires" },
{ "cle": "guest", "valeur": "Guest" }]        
export var statsCounter = [{ "cle": "counter_5", "valeur": "Counter 5" },
